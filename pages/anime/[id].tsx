    ...
    <>
      ...
      <div className="min-h-screen bg-black">
        ...
        <div className="relative w-full overflow-hidden" style={{ minHeight: '480px' }}>
          ...
          {/* Hero Content */}
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-20 flex flex-col md:flex-row items-end gap-8">
            {/* Poster */}
            ...
            {/* Title & meta */}
            <div className="animate-slide-up pb-2 flex-1">
              ...
              <div className="flex flex-wrap gap-3">
                <button
                  ...
                  onClick={toggleFav}
                  aria-pressed={isFav}
                  className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-accent/50 ${isFav ? 'bg-rose-500 text-white shadow-lg shadow-rose-500/30 hover:bg-rose-600' : 'bg-white/10 backdrop-blur-sm border border-white/10 text-white hover:bg-white/20'}`}
                >
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-accent/50 ${isInWatchlist ? 'bg-accent text-white shadow-lg shadow-accent/30 hover:bg-accent/90' : 'bg-white/10 backdrop-blur-sm border border-white/10 text-white hover:bg-white/20'}`}
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              {anime.trailer?.embed_url && (
                <div className="rounded-2xl overflow-hidden shadow-2xl ring-1 ring-white/5 bg-gray-900">
                  <div className="flex items-center gap-2 px-4 py-3 border-b border-white/5">
                    <Play className="w-4 h-4 text-accent fill-current" />
                    <span className="text-sm font-semibold text-gray-300">Official Trailer</span>
                  </div>
